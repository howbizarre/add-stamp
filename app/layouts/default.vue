...
/**
 * The chrome every page shares: the organic ground, the mat-width column, the masthead and
 * the footer. Pages only ever fill `main`.
 */
</script>
  ...
  <div class="relative z-10 mx-auto flex min-h-dvh max-w-7xl flex-col px-5">
    ...
    <footer class="site-footer">
      ...
      <p class="flex items-center gap-4">
        <NuxtLink to="/how-to-use" class="text-sm transition-colors hover:text-ink">How to use</NuxtLink>
